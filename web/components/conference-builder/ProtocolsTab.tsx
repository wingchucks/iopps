...
export function ProtocolsTab({ conference, onChange }: ProtocolsTabProps) {
    return (
        <div className="p-6 max-w-3xl space-y-8">
            <div className="rounded-xl bg-accent/10 border border-[#14B8A6]/20 p-4">
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-xs text-foreground0 mb-2">Whose traditional territory is the event taking place on?</p>
                    <textarea
                        rows={3}
                        ...
                        className="w-full rounded-lg border border-[var(--card-border)] bg-surface px-4 py-2 text-foreground focus:border-[#14B8A6] focus:outline-none"
                    />
                </div>
                ...
                <div>
                    ...
                    <p className="text-xs text-foreground0 mb-2">Will an Elder be providing an opening prayer or welcome?</p>
                    <textarea
                        rows={2}
                ...
                <div>
                    ...
                    <p className="text-xs text-foreground0 mb-2">Any specific protocols attendees should be aware of?</p>
                    <textarea
                        rows={3}
                ...
                <div className="flex items-center gap-3 rounded-lg border border-[var(--card-border)] bg-surface p-4">
                    <input
                        type="checkbox"
                    ...
                    <label htmlFor="trc92" className="cursor-pointer">
                        <span className="block text-sm font-medium text-foreground">Commitment to TRC Call to Action #92</span>
