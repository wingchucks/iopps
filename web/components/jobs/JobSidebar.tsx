            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                        <div className="mt-1 flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-foreground0">
                    ...
                    {job.willTrain && (
                        <div className="flex items-start gap-3">
                            <div className="mt-1 flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-50 text-accent">
                                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
