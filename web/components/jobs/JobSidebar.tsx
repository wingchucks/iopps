    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
                <h3 className="mb-4 text-lg font-bold text-slate-800">Job Overview</h3>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-sm font-medium text-slate-500">Date Posted</p>
                            <p className="text-sm font-semibold text-slate-700">{postedDate || "Recently"}</p>
                        </div>
                    </div>
                    ...
                    {deadline && (
                        <div className="flex items-start gap-3">
                            <div className="mt-1 flex h-8 w-8 items-center justify-center rounded-lg bg-amber-50 text-amber-500">
                                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    {getSalaryDisplay(job) && (
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-semibold text-slate-700">{getSalaryDisplay(job)}</p>
                            </div>
                        </div>
                    )}
                    ...
                    {job.category && (
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-semibold text-slate-700">{job.category}</p>
                            </div>
                        </div>
                    )}
                    ...
                    {job.cpicRequired && (
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-medium text-slate-500">Background Check</p>
                                <p className="text-sm font-semibold text-amber-600">CPIC Required</p>
                            </div>
                        </div>
                    )}
                    ...
                    {job.willTrain && (
                        <div className="flex items-start gap-3">
                            <div className="mt-1 flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-50 text-emerald-500">
                                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                            </div>
                            <div>
                                <p className="text-sm font-medium text-slate-500">Training</p>
                                <p className="text-sm font-semibold text-emerald-600">Will Train</p>
                            </div>
                        </div>
                    )}
                </div>
            ...
            {job.employerName && (
                <div className="rounded-2xl border border-slate-200 bg-white p-6">
                    <h3 className="mb-4 text-lg font-bold text-slate-800">About the Employer</h3>
                        ...
                        <div>
                            {job.employerId ? (
                                <Link
                                    ...
                                    className="font-bold text-slate-800 hover:text-[#0D9488] transition-colors"
                                >
                                    {job.employerName}
                                </Link>
                            ) : (
                                <p className="font-bold text-slate-800">{job.employerName}</p>
                            )}
                    ...
                    {employerProfile?.description && (
                        <p className="mt-4 text-sm text-slate-500 line-clamp-4">
                            {employerProfile.description}
                        </p>
                    )}
                    {job.employerId && (
            ...
            {/* Share Job */}
            <div className="rounded-2xl border border-slate-200 bg-white p-6">
                <h3 className="mb-4 text-lg font-bold text-slate-800">Share this Job</h3>
                <ShareButtons
                    item={{
                        id: job.id,
