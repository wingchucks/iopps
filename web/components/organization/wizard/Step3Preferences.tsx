        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4 rounded-xl border border-slate-800 bg-slate-900/50 p-6">
                <label className="flex items-center justify-between cursor-pointer">
                    ...
                    <div className={`relative flex h-6 w-11 items-center rounded-full transition-colors ${data.indigenousPreference ? 'bg-[#14B8A6]' : 'bg-slate-700'}`}>
                        <input
                            type="checkbox"
                ...
                <label className="flex items-center justify-between cursor-pointer border-t border-slate-800 pt-4">
                    ...
                    <div className={`relative flex h-6 w-11 items-center rounded-full transition-colors ${data.quickApplyEnabled ? 'bg-[#14B8A6]' : 'bg-slate-700'}`}>
                        <input
                            type="checkbox"
            ...
            <div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    <input
                        ...
                        className="w-full rounded-xl border border-slate-800 bg-slate-900 px-4 py-3 text-slate-100 focus:border-[#14B8A6] focus:outline-none"
                    />
                    <input
                        type="email"
            ...
            <div>
                ...
                <div className="relative mt-1">
                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        <svg className="h-5 w-5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                    </div>
                    <input
                        type="url"
                        ...
                        className="w-full rounded-xl border border-slate-800 bg-slate-900 py-3 pl-10 pr-4 text-slate-100 focus:border-[#14B8A6] focus:outline-none"
                    />
                </div>
            </div>
