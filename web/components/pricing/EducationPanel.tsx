...
export default function EducationPanel() {
  ...
  return (
    <div>
      ...
      <div className="mb-12">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-foreground">For Schools & Education Institutions</h2>
        ...
        <div className="mt-8 max-w-2xl rounded-xl border border-[#14B8A6]/30 bg-accent/10 p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-foreground">3-Month Trial Available</h3>
              <p className="mt-1 text-sm text-[var(--text-muted)]">
                Want to try before you commit? Contact us to discuss a 3-month trial period for your institution.
              </p>
              <Link 
                href="/contact" 
                className="mt-3 inline-flex items-center gap-2 rounded-full bg-accent px-4 py-2 text-sm font-semibold text-white hover:bg-accent/80 transition"
              >
                Request Trial
              </Link>
            </div>
        ...
        <div className="mt-10 max-w-3xl">
          <h3 className="text-lg font-semibold text-foreground mb-6">Everything You Need</h3>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-[var(--card-border)] bg-surface p-4 text-center">
              <div className="text-2xl mb-2">💼</div>
              <h4 className="font-semibold text-foreground">Unlimited Jobs</h4>
              <p className="text-xs text-[var(--text-muted)] mt-1">Post as many positions as you need</p>
            </div>
            <div className="rounded-xl border border-[var(--card-border)] bg-surface p-4 text-center">
              <div className="text-2xl mb-2">📚</div>
              <h4 className="font-semibold text-foreground">Unlimited Programs</h4>
              <p className="text-xs text-[var(--text-muted)] mt-1">Showcase all your courses & certifications</p>
            </div>
            <div className="rounded-xl border border-[var(--card-border)] bg-surface p-4 text-center">
              <div className="text-2xl mb-2">🎁</div>
              <h4 className="font-semibold text-foreground">Unlimited Scholarships</h4>
              <p className="text-xs text-[var(--text-muted)] mt-1">List all awards & financial aid</p>
            </div>
            <div className="rounded-xl border border-[var(--card-border)] bg-surface p-4 text-center">
              <div className="text-2xl mb-2">🎓</div>
              <h4 className="font-semibold text-foreground">School Profile</h4>
              <p className="text-xs text-[var(--text-muted)] mt-1">Full branded presence on IOPPS</p>
            </div>
            <div className="rounded-xl border border-[var(--card-border)] bg-surface p-4 text-center">
              <div className="text-2xl mb-2">⭐</div>
              <h4 className="font-semibold text-foreground">Featured Placement</h4>
              <p className="text-xs text-[var(--text-muted)] mt-1">Priority visibility in directory</p>
            </div>
            <div className="rounded-xl border border-[var(--card-border)] bg-surface p-4 text-center">
              <div className="text-2xl mb-2">📊</div>
              <h4 className="font-semibold text-foreground">Analytics</h4>
              <p className="text-xs text-[var(--text-muted)] mt-1">Track engagement & inquiries</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-foreground">For Training Providers</h2>
          <p className="mt-2 text-[var(--text-muted)]">
        ...
        <div className="max-w-3xl space-y-4 mb-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-semibold text-foreground">Programs Under 3 Months</h3>
                  <span className="rounded-full bg-accent px-2 py-0.5 text-xs font-bold text-white">FREE</span>
                </div>
                <p className="mt-1 text-sm text-[var(--text-muted)]">
          ...
          <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-semibold text-foreground">Programs 3+ Months</h3>
        ...
        <h3 className="text-lg font-semibold text-foreground mb-4">Listing Options for 3+ Month Programs</h3>
      ...
      {/* Talk to us CTA */}
      <div className="mt-12 rounded-xl border border-[var(--card-border)] bg-surface p-6 text-center">
