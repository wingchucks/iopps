...
export default function LiveStreamingPanel() {
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-foreground">Live Streaming Services</h2>
      ...
      {/* Custom quote card */}
      <div className="max-w-2xl rounded-2xl border border-[#14B8A6] bg-accent/5 p-8">
        <div className="flex items-start gap-4">
          <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full bg-accent/20">
          ...
          <div className="flex-1">
            ...
            <div className="mt-6 space-y-3">
              <h4 className="text-sm font-semibold text-foreground">What we offer:</h4>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-lg border border-[var(--card-border)] bg-slate-800/60 px-6 py-3 text-sm font-semibold text-foreground transition hover:border-[#14B8A6]"
              >
                Contact Form
              </Link>
            </div>
      ...
      <div className="mt-8 rounded-xl border border-[var(--card-border)] bg-surface p-6">
        <h3 className="font-semibold text-foreground">Recent Streaming Events</h3>
