      ...
      try {
        ...
        const mapped: Opportunity[] = [
          ...jobs.slice(0, 10).map((job) => ({
            ...
            type: "job" as const,
            title: job.title,
            organizationName: job.employerName || "",
            ...
            trcAligned: !!(job.trcAlignment?.hasIndigenousHiringStrategy || job.trcAlignment?.isIndigenousOwned),
            originalObject: job,
          })),
          ...scholarships.slice(0, 5).map((s) => ({
            ...
            title: s.title || "",
            organizationName: s.provider || "",
            organizationId: s.employerId || "",
            location: s.region || "National",
          ...
          ...powwows.slice(0, 5).map((p) => ({
            ...
            type: "event" as const,
            title: p.name || "",
            organizationName: p.host || "",
            organizationId: p.employerId || "",
            location: p.location || "",
