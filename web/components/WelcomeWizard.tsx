...
export default function WelcomeWizard({
      ...
      case 0:
        return (
          <div className="text-center">
            <div className="mb-6 inline-flex h-24 w-24 items-center justify-center rounded-full bg-emerald-500/20">
        ...
        return (
          <div className="text-center">
            ...
            <div className="mt-8 space-y-4 text-left">
              <div className="flex items-start gap-4 rounded-xl border border-slate-700 bg-slate-800/50 p-4">
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-emerald-500/20 text-lg">
                  1
                </div>
                <div>
          ...
          <div className="text-center">
            ...
            <div className="mt-8 space-y-4">
              <Link
                ...
                className="flex items-center justify-between rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-4 transition-colors hover:bg-emerald-500/20"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-slate-400">Add logo, description, and details</p>
                  </div>
                </div>
              ...
              <Link
                ...
                className="flex items-center justify-between rounded-xl border border-slate-700 bg-slate-800/50 p-4 transition-colors hover:bg-slate-800"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-slate-400">Ready to post once approved</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-slate-400">Discover Indigenous professionals</p>
                  </div>
                </div>
                <span className="text-slate-400">→</span>
              </Link>
  ...
  return (
    ...
    >
      <div
        className={`relative w-full max-w-2xl rounded-3xl border border-slate-700 bg-slate-900 p-8 shadow-2xl transition-transform duration-300 ${
      ...
      >
        ...
        <button
          onClick={handleSkip}
          className="absolute right-6 top-6 text-sm text-slate-400 hover:text-white transition-colors"
        >
          Skip
        </button>
