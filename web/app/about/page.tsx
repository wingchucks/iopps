    ...
    <div className="mx-auto max-w-5xl px-4 py-10 space-y-12">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Link href="/education/scholarships" className="group rounded-xl border border-slate-800 bg-slate-900/60 p-5 transition-all hover:border-[#14B8A6]/50 hover:bg-slate-900">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#14B8A6]/20 transition-colors group-hover:bg-[#14B8A6]/30">
              <svg className="h-5 w-5 text-[#14B8A6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <h3 className="mt-3 text-lg font-semibold text-slate-50">Scholarships & Grants</h3>
            <p className="mt-2 text-sm text-slate-400">
              Access funding opportunities for education, training, and community development.
            </p>
          </Link>

          <Link href="/business" className="group rounded-xl border border-slate-800 bg-slate-900/60 p-5 transition-all hover:border-[#14B8A6]/50 hover:bg-slate-900">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#14B8A6]/20 transition-colors group-hover:bg-[#14B8A6]/30">
              <svg className="h-5 w-5 text-[#14B8A6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/conferences" className="group rounded-xl border border-slate-800 bg-slate-900/60 p-5 transition-all hover:border-[#14B8A6]/50 hover:bg-slate-900">
            ...
            <h3 className="mt-3 text-lg font-semibold text-slate-50">Conferences & Events</h3>
            <p className="mt-2 text-sm text-slate-400">
              Connect at career fairs, leadership summits, and professional development events.
            </p>
          </Link>

          <Link href="/community" className="group rounded-xl border border-slate-800 bg-slate-900/60 p-5 transition-all hover:border-[#14B8A6]/50 hover:bg-slate-900">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#14B8A6]/20 transition-colors group-hover:bg-[#14B8A6]/30">
              <svg className="h-5 w-5 text-[#14B8A6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
