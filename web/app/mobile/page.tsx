                    ...
                    <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-3">
                                        <input
                                            ...
                                            className="flex-1 rounded-lg border border-slate-200 bg-white px-4 py-3 text-slate-900 placeholder-slate-400 focus:border-[#14B8A6] focus:outline-none focus:ring-2 focus:ring-[#14B8A6]/30"
                                            required
                                        />
                                        <button
                                            type="submit"
                        ...
                        <div className="relative flex items-center justify-center">
                            <div className="relative">
                                ...
                                {/* Phone frame */}
                                <div className="relative rounded-[3rem] border-8 border-slate-200 bg-white p-4 shadow-2xl">
                                    <div className="h-[600px] w-[280px] overflow-hidden rounded-[2rem] bg-gradient-to-b from-white to-slate-50">
                                        {/* Notch */}
                                        <div className="mx-auto mt-2 h-6 w-32 rounded-full bg-slate-200" />

                                        {/* App Preview Content */}
                                        <div className="p-6 space-y-6">
                                            <div>
                                                <h2 className="text-2xl font-bold text-slate-900">IOPPS</h2>
                                                <p className="text-xs text-slate-500">Indigenous Opportunities</p>
                                            </div>
                                            ...
                                            <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-2">
                                                ...
                                                <h3 className="text-sm font-semibold text-slate-900">Software Developer</h3>
                                            ...
                                            <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-2">
                                                ...
                                                <h3 className="text-sm font-semibold text-slate-900">Indigenous Youth Grant</h3>
                                                <p className="text-xs text-slate-500">Deadline in 14 days</p>
                                            </div>
                                            ...
                                            <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-2">
                                                ...
                                                <h3 className="text-sm font-semibold text-slate-900">Indigenous Career Fair</h3>
                                                <p className="text-xs text-slate-500">Vancouver • May 15</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section className="mx-auto max-w-7xl px-4 py-20">
                ...
                <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    {[
                        ...
                        <div
                            key={feature.title}
                            className="rounded-2xl border border-slate-200 bg-white p-6 transition hover:border-[#14B8A6]/30 hover:bg-slate-50"
                        >
