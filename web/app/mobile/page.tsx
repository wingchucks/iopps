...
export default function MobileAppPage() {
    ...
    return (
        <div className="min-h-screen bg-[#020306]">
            {/* Hero Section */}
            <section className="relative overflow-hidden border-b border-slate-800/50 bg-gradient-to-b from-[#08090C] to-[#020306]">
                ...
                <div className="relative mx-auto max-w-7xl px-4 py-20 sm:py-32">
                    <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
                        ...
                        <div className="flex flex-col justify-center">
                            <div className="inline-flex items-center gap-2 rounded-full border border-[#14B8A6]/30 bg-[#14B8A6]/10 px-4 py-1.5 w-fit">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-3">
                                        <input
                                            ...
                                            className="flex-1 rounded-lg border border-slate-700 bg-slate-900/60 px-4 py-3 text-slate-100 placeholder-slate-500 focus:border-[#14B8A6] focus:outline-none focus:ring-2 focus:ring-[#14B8A6]/30"
                                            required
                                        />
                                        <button
                                            type="submit"
                                            disabled={submitting}
                                            className="rounded-lg bg-[#14B8A6] px-6 py-3 font-semibold text-slate-900 transition hover:bg-[#0F9488] disabled:opacity-50"
                                        >
                        ...
                        <div className="relative flex items-center justify-center">
                            <div className="relative">
                                ...
                                {/* Phone frame */}
                                <div className="relative rounded-[3rem] border-8 border-slate-800 bg-slate-900 p-4 shadow-2xl">
                                    <div className="h-[600px] w-[280px] overflow-hidden rounded-[2rem] bg-gradient-to-b from-[#08090C] to-[#020306]">
                                        {/* Notch */}
                                        <div className="mx-auto mt-2 h-6 w-32 rounded-full bg-slate-950" />

                                        {/* App Preview Content */}
                                        <div className="p-6 space-y-6">
                                            <div>
                                                <h2 className="text-2xl font-bold text-slate-50">IOPPS</h2>
                                                <p className="text-xs text-slate-400">Indigenous Opportunities</p>
                                            </div>
                                            ...
                                            <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4 space-y-2">
                                                ...
                                                <h3 className="text-sm font-semibold text-slate-100">Software Developer</h3>
                                            ...
                                            <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4 space-y-2">
                                                ...
                                                <h3 className="text-sm font-semibold text-slate-100">Indigenous Youth Grant</h3>
                                                <p className="text-xs text-slate-400">Deadline in 14 days</p>
                                            </div>
                                            ...
                                            <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4 space-y-2">
                                                ...
                                                <h3 className="text-sm font-semibold text-slate-100">Indigenous Career Fair</h3>
                                                <p className="text-xs text-slate-400">Vancouver • May 15</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section className="mx-auto max-w-7xl px-4 py-20">
                ...
                <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    {[
                        ...
                        <div
                            key={feature.title}
                            className="rounded-2xl border border-slate-800 bg-slate-900/40 p-6 transition hover:border-[#14B8A6]/30 hover:bg-slate-900/60"
                        >
            ...
            {/* Platform Stats */}
            <section className="border-t border-slate-800/50 bg-gradient-to-b from-[#020306] to-[#08090C]">
            ...
            <section className="border-t border-slate-800/50">
                <div className="mx-auto max-w-4xl px-4 py-20 text-center">
                    ...
                    <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                        <div className="flex items-center gap-3 rounded-lg border border-slate-700 bg-slate-900/40 px-6 py-3">
                            ...
                            <div className="text-left">
                                ...
                                <div className="text-sm font-semibold text-slate-200">App Store</div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 rounded-lg border border-slate-700 bg-slate-900/40 px-6 py-3">
                            ...
                            <div className="text-left">
                                ...
                                <div className="text-sm font-semibold text-slate-200">Google Play</div>
                            </div>
                        </div>
                    </div>
