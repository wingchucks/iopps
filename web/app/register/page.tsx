              ...
              <div>
                ...
                <div className="mt-3 grid gap-3 sm:grid-cols-2">
                  <button
                    ...
                    className={`flex flex-col items-start rounded-xl border px-4 py-3 text-left transition ${role === "community"
                  ...
                  <button
                    ...
                    className={`flex flex-col items-start rounded-xl border px-4 py-3 text-left transition ${role === "employer"
                      ? "border-[#14B8A6] bg-[#14B8A6]/10"
                      : "border-slate-700 bg-slate-900 hover:border-slate-600"
                      }`}
                  >
