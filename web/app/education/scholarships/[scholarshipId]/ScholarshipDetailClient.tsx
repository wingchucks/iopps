...
export default function ScholarshipDetailClient({ scholarship: initialScholarship, error: initialError }: ScholarshipDetailClientProps) {
  ...
  const [scholarship] = useState<Scholarship | null>(initialScholarship);
