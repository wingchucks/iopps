        ...
        <div className="space-y-8">
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div
                                        className={`flex h-10 w-10 items-center justify-center rounded-lg ${isEnabled ? "bg-amber-500/20" : "bg-emerald-500/20"
                                            }`}
                                    >
                                        <Icon
                                            className={`h-5 w-5 ${isEnabled ? "text-amber-500" : "text-emerald-500"
                                                }`}
                                        />
                                    </div>
                                    <div>
                                        <h3 className="font-medium text-slate-100">{pillar.label}</h3>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <button
                                        ...
                                        disabled={isSaving}
                                        className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#14B8A6] focus:ring-offset-2 focus:ring-offset-slate-900 disabled:cursor-not-allowed disabled:opacity-50 ${isEnabled ? "bg-amber-500" : "bg-slate-600"
                                            }`}
                                    >
                                        <span
            ...
            <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4">
                ...
                <ul className="mt-2 space-y-1 text-sm text-slate-400">
                    ...
                    <li>• <strong className="text-emerald-400">Free</strong> — Users can post immediately without payment</li>
