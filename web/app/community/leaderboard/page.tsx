          ...
          <div className="space-y-6">
                ...
                <div className="space-y-3">
                  {spotlight.map((entry, index) => (
                    <Link
                      ...
                      className={`flex items-center gap-3 p-3 rounded-xl transition-all hover:bg-slate-800 ${
                        index === 0
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="font-semibold text-white">Rising Stars</h2>
              </div>
                ...
                <div className="space-y-3">
                  {risingStars.map((entry) => (
                    <Link
                      key={entry.userId}
                      href={`/member/${entry.userId}`}
                      className="flex items-center gap-3 p-3 rounded-xl border border-slate-700 hover:bg-slate-800 transition-colors"
                    >
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between text-slate-400">
                  ...
                  <span className="text-white">+0.5 pts</span>
                </div>
              </div>
