      ...
      <div className="space-y-8">
        ...
        <div className="prose prose-slate max-w-none space-y-6">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            ...
            <h3 className="text-lg font-semibold text-slate-800 mt-6 mb-3">1.1 Information You Provide</h3>
            <p className="text-sm text-slate-600 leading-relaxed mb-3">When you create an account or use our services, you may provide:</p>
            ...
            <h3 className="text-lg font-semibold text-slate-800 mt-6 mb-3">1.2 Automatically Collected Information</h3>
            <p className="text-sm text-slate-600 leading-relaxed mb-3">When you use our platform, we automatically collect:</p>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            ...
            <p className="text-sm text-slate-600 leading-relaxed mb-3">We use your information to:</p>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">3. AI and Automated Processing</h2>
            <p className="text-sm text-slate-600 leading-relaxed mb-3">IOPPS uses AI and machine learning technologies to enhance our services:</p>
            <h3 className="text-lg font-semibold text-slate-800 mt-6 mb-3">3.1 AI-Powered Features</h3>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
            ...
            <h3 className="text-lg font-semibold text-slate-800 mt-6 mb-3">3.2 How AI Processes Your Data</h3>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
            ...
            <h3 className="text-lg font-semibold text-slate-800 mt-6 mb-3">3.3 Your AI Choices</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            ...
            <h3 className="text-lg font-semibold text-slate-800 mt-6 mb-3">4.1 With Other Users</h3>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
            ...
            <h3 className="text-lg font-semibold text-slate-800 mt-6 mb-3">4.2 With Service Providers</h3>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
            ...
            <h3 className="text-lg font-semibold text-slate-800 mt-6 mb-3">4.3 Legal Requirements</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">5. Payment Processing</h2>
            <p className="text-sm text-slate-600 leading-relaxed mb-3">IOPPS uses Stripe for all financial transactions:</p>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">6. Cookies and Local Storage</h2>
            <p className="text-sm text-slate-600 leading-relaxed mb-3">We use cookies and similar technologies:</p>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">8. Your Rights and Choices</h2>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">9. Indigenous Data Sovereignty</h2>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">10-12. Additional Provisions</h2>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">13. Canadian Privacy Law (PIPEDA)</h2>
            <p className="text-sm text-slate-600 leading-relaxed mb-3">As a Canadian user, you have the right to:</p>
            <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 ml-4">
