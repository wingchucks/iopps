...
export default function OrganizationProfileLoading() {
  return (
    <FeedLayout activeNav="organizations" fullWidth>
      {/* Header Skeleton */}
      <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-200 mb-8 animate-pulse">
        {/* Banner */}
        ...
        <div className="relative px-6 pb-6 sm:px-8 sm:pb-8">
          ...
          <div className="absolute -top-16 sm:-top-20">
            <div className="h-24 w-24 sm:h-32 sm:w-32 rounded-2xl bg-slate-200 border-4 border-white" />
          </div>
      ...
      {/* Tabs Skeleton */}
      <div className="mb-8 flex items-center gap-2 pb-2 border-b border-slate-200">
        {[...Array(4)].map((_, i) => (
