      ...
      <div className="space-y-8">
        ...
        <div className="prose prose-slate max-w-none space-y-6">
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">Agreement to Terms</h2>
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">1. Platform Purpose</h2>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed mb-3">IOPPS is designed to:</p>
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">2. User Accounts</h2>
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mt-6 mb-3">2.1 Account Creation</h3>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed mb-3">To use certain features, you must create an account. You agree to:</p>
            <ul className="list-disc list-inside text-sm text-[var(--text-secondary)] space-y-2 ml-4">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mt-6 mb-3">2.2 Account Types</h3>
            <ul className="list-disc list-inside text-sm text-[var(--text-secondary)] space-y-2 ml-4">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mt-6 mb-3">2.3 Account Termination</h3>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">3. User Conduct</h2>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed mb-3">When using IOPPS, you agree NOT to:</p>
            <ul className="list-disc list-inside text-sm text-[var(--text-secondary)] space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">4. Employer Responsibilities</h2>
            <ul className="list-disc list-inside text-sm text-[var(--text-secondary)] space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">5. Vendor Responsibilities</h2>
            <ul className="list-disc list-inside text-sm text-[var(--text-secondary)] space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">6. Payments and Subscriptions</h2>
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mt-6 mb-3">6.1 Payment Processing</h3>
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mt-6 mb-3">6.2 Employer Subscriptions</h3>
            <ul className="list-disc list-inside text-sm text-[var(--text-secondary)] space-y-2 ml-4">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mt-6 mb-3">6.3 Refund Policy</h3>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">7. Artificial Intelligence Features</h2>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed mb-3">When using AI features, you agree to:</p>
            <ul className="list-disc list-inside text-sm text-[var(--text-secondary)] space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">8. Content Ownership and License</h2>
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mt-6 mb-3">8.1 Your Content</h3>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed mb-3">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mt-6 mb-3">8.2 Platform Content</h3>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">9. Privacy and Data</h2>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">10. Disclaimers</h2>
            <ul className="list-disc list-inside text-sm text-[var(--text-secondary)] space-y-2 ml-4">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">11. Limitation of Liability</h2>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed mb-3">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">12-15. Additional Provisions</h2>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed mb-3">
          ...
          <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 sm:p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">16. Contact Information</h2>
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed mb-4">Questions about these Terms? Contact us:</p>
          ...
          <div className="rounded-2xl border border-[#0D9488]/20 bg-[#F0FDFA] p-6 sm:p-8">
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
              <strong className="text-[var(--text-primary)]">Acknowledgment:</strong> By using IOPPS, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service and our Privacy Policy.
            </p>
          </div>
