// ImageResponse import removed as it is not used in the template component
            ...
            >
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                        ...
                        <span style={{ fontSize: 40, fontWeight: 900, color: "white", letterSpacing: "-0.02em" }}>
                            IOPPS.ca
                        </span>
                    </div>
                    ...
                    >
                        <span style={{ fontSize: 20, color: "#14B8A6", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em" }}>
                            {type}
                        </span>
                    </div>
                </div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "40px", marginTop: "auto", marginBottom: "auto" }}>
                    {imageUrl && (
                        ...
                        >
                            {/* Using img tag directly for OG generation */}
