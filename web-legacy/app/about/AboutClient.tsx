    ...
    <FeedLayout>
      <div className="space-y-10">
        ...
        <section className="text-center py-4">
          ...
          <p className="mt-4 text-2xl font-medium text-[var(--text-secondary)]">
        ...
        <section className="rounded-2xl border border-[#0D9488]/20 bg-gradient-to-br from-[#F0FDFA] via-white to-[#F0FDFA] p-8 sm:p-10 shadow-sm">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-2xl font-bold text-[var(--text-primary)]">Our Symbol</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-[var(--text-primary)]">What IOPPS Offers</h2>

          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Link href="/careers" className="group rounded-xl border border-[var(--border)] bg-[var(--card-bg)] p-5 shadow-sm transition-all hover:border-[#0D9488]/40 hover:shadow-md">
              ...
              <h3 className="mt-3 text-lg font-semibold text-[var(--text-primary)]">Jobs & Careers</h3>
            ...
            <Link href="/education/scholarships" className="group rounded-xl border border-[var(--border)] bg-[var(--card-bg)] p-5 shadow-sm transition-all hover:border-[#0D9488]/40 hover:shadow-md">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0D9488]/10 transition-colors group-hover:bg-[#0D9488]/20">
                <svg className="h-5 w-5 text-[#0D9488]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h3 className="mt-3 text-lg font-semibold text-[var(--text-primary)]">Scholarships & Grants</h3>
              <p className="mt-2 text-sm text-foreground0">
                Access funding opportunities for education, training, and community development.
              </p>
            </Link>

            <Link href="/business" className="group rounded-xl border border-[var(--border)] bg-[var(--card-bg)] p-5 shadow-sm transition-all hover:border-[#0D9488]/40 hover:shadow-md">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0D9488]/10 transition-colors group-hover:bg-[#0D9488]/20">
                <svg className="h-5 w-5 text-[#0D9488]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                </svg>
              </div>
              <h3 className="mt-3 text-lg font-semibold text-[var(--text-primary)]">Shop Indigenous</h3>
              <p className="mt-2 text-sm text-foreground0">
                Support Indigenous-owned businesses, artisans, and entrepreneurs.
              </p>
            </Link>

            <Link href="/conferences" className="group rounded-xl border border-[var(--border)] bg-[var(--card-bg)] p-5 shadow-sm transition-all hover:border-[#0D9488]/40 hover:shadow-md">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0D9488]/10 transition-colors group-hover:bg-[#0D9488]/20">
                <svg className="h-5 w-5 text-[#0D9488]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <h3 className="mt-3 text-lg font-semibold text-[var(--text-primary)]">Conferences & Events</h3>
              <p className="mt-2 text-sm text-foreground0">
                Connect at career fairs, leadership summits, and professional development events.
              </p>
            </Link>

            <Link href="/community" className="group rounded-xl border border-[var(--border)] bg-[var(--card-bg)] p-5 shadow-sm transition-all hover:border-[#0D9488]/40 hover:shadow-md">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0D9488]/10 transition-colors group-hover:bg-[#0D9488]/20">
                <svg className="h-5 w-5 text-[#0D9488]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              </div>
              <h3 className="mt-3 text-lg font-semibold text-[var(--text-primary)]">Pow Wows & Events</h3>
              <p className="mt-2 text-sm text-foreground0">
                Find traditional gatherings, competitions, and cultural celebrations.
              </p>
            </Link>

            <Link href="/live" className="group rounded-xl border border-[var(--border)] bg-[var(--card-bg)] p-5 shadow-sm transition-all hover:border-[#0D9488]/40 hover:shadow-md">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0D9488]/10 transition-colors group-hover:bg-[#0D9488]/20">
                <svg className="h-5 w-5 text-[#0D9488]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="mt-3 text-lg font-semibold text-[var(--text-primary)]">Live Streams</h3>
              <p className="mt-2 text-sm text-foreground0">
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          <article className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 shadow-sm">
            <h3 className="text-xl font-bold text-[var(--text-primary)]">For Employers & Partners</h3>
          ...
          <article className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 shadow-sm">
            <h3 className="text-xl font-bold text-[var(--text-primary)]">For Community Members</h3>
            <p className="mt-3 text-sm leading-relaxed text-foreground0">
