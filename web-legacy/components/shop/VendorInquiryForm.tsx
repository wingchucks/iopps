    ...
    <div className="rounded-2xl bg-surface border border-[var(--card-border)] p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-[var(--text-muted)]">Contact {vendorName} directly</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg bg-slate-700/50 border border-[var(--card-border)] px-4 py-2.5 text-white placeholder-slate-500 focus:border-accent focus:outline-none"
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-lg bg-slate-700/50 border border-[var(--card-border)] px-4 py-2.5 text-white placeholder-slate-500 focus:border-accent focus:outline-none resize-none"
