...
export function DashboardEntryCTA({
  ...
  return (
    <Link
      href={dashboardHref}
      className={`inline-flex items-center justify-center rounded-full bg-accent px-6 py-3 text-sm font-bold text-[var(--text-primary)] shadow-lg transition-all hover:-translate-y-0.5 hover:bg-[#16cdb8] hover:shadow-xl ${className}`}
    >
      {dashboardLabel}
    </Link>
  );
