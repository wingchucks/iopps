...
export default function PartnersClient({ initialOrgs }: { initialOrgs: Organization[] }) {
  return (
    <AppShell>
      <div className="min-h-screen bg-bg">
        <PartnersContent initialOrgs={initialOrgs} />
      </div>
    </AppShell>
  );
}

function PartnersContent({ initialOrgs }: { initialOrgs: Organization[] }) {
  const { user } = useAuth();
