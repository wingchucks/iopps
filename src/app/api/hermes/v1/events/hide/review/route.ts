...
import { handleHermesEventHideReviewRequest, hermesAdminInternalErrorResponse } from "@/lib/server/hermes-admin-api";
...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    return await handleHermesEventHideReviewRequest(request, {
    ...
    console.error("[hermes-admin] Event-hide review initialization failed:", error instanceof Error ? error.name : "UnknownError");
