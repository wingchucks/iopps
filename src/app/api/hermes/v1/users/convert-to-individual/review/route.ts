...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    return await handleHermesAccountConversionReviewRequest(request, {
    ...
    console.error("[hermes-admin] Conversion review initialization failed:", error instanceof Error ? error.name : "UnknownError");
