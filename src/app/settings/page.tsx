          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/contact" className="no-underline">
              <Card className="hover:border-teal/30 transition-colors">
                <div className="flex items-center gap-4 p-4">
                  <div className="flex-1">
                    <h3 className="text-[15px] font-bold text-text mb-0.5">Help &amp; Support</h3>
                    <p className="text-sm text-text-muted m-0">Contact the IOPPS team for help with your account</p>
                  </div>
                  <span className="text-text-muted text-lg">&rsaquo;</span>
                </div>
              </Card>
