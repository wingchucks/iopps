...
test('dashboard excludes deleted canonical jobs and legacy posts before counting applications',async()=>{
 ...
 const db={collection(name){const q={where(field,op,value){if(name==='applications')reads.push(value);return q;},orderBy(){return q;},limit(){return q;},get:async()=>({docs:fixtures[name]||[],size:0})};return q;}};
