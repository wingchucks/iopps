...
run('opt-in-browsers',['--import',new URL('./test-typescript-loader.mjs',import.meta.url).href,'--test','tests/jobs-listing-browser.test.mjs','tests/qa-accessibility-nav-browser.test.mjs','tests/organization-admin-assignment-browser.test.mjs'],{IOPPS_TEST_JOBS_BROWSER:'true',IOPPS_QA_ACCESSIBILITY_BROWSER:'true',IOPPS_TEST_ASSIGNMENT_BROWSER:'true',IOPPS_QA_ACCESSIBILITY_EVIDENCE:output});
run('next-browser',['--import',new URL('./test-typescript-loader.mjs',import.meta.url).href,'scripts/qa-seven-browser.mjs']);
