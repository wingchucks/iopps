// Parent-owned full verification; demo Firebase only, never production.
...
const output=process.env.IOPPS_CLEANUP_OUTPUT||'C:/Users/natha/Documents/Codex/2026-09-21/individual-safe-cleanup/acceptance';
...
function run(name,args){
 ...
 const result=spawnSync(process.execPath,args,{env:{...process.env,IOPPS_TEST_EMULATORS:'true',IOPPS_TEST_MEMBER_RETIREMENT:'true',IOPPS_QA3_OUTPUT:output,USERPROFILE:'C:/Users/natha',LOCALAPPDATA:'C:/Users/natha/AppData/Local',APPDATA:'C:/Users/natha/AppData/Roaming',PROGRAMFILES:'C:/Program Files'},stdio:['ignore',fd,fd]});
...
if(results.find(r=>r.name==='build')?.status===0){
 ok=run('cleanup-browser',['--import',loader,'scripts/qa-safe-cleanup-browser.mjs'])&&ok;
 ok=run('qa3-browser',['--import',loader,'scripts/qa-individual3-browser.mjs'])&&ok;
 ok=run('regression-browser',['--import',loader,'scripts/qa-round2-browser.mjs'])&&ok;
}
